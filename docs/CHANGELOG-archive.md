...
Release history for warren **0.9.10 and earlier**, split out of the live
[`CHANGELOG.md`](../CHANGELOG.md) so the active file stays readable
(warren-222c). Nothing here is maintained — it is kept verbatim for
provenance. New entries always go in the live changelog.
