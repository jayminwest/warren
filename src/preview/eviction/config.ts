 ...
 * of src/preview/eviction.ts). Defaults match docs/design/preview-environments.md; malformed
...
/** docs/design/preview-environments.md: idle-TTL default 30 minutes. */
export const DEFAULT_IDLE_TTL_MS = 30 * 60_000;
/** docs/design/preview-environments.md: max-lifetime default 8 hours. */
export const DEFAULT_MAX_LIFETIME_MS = 8 * 3_600_000;
/** docs/design/preview-environments.md: max live cap default 20. */
...
/**
 * Resolve eviction config from env. Defaults match docs/design/preview-environments.md; malformed
